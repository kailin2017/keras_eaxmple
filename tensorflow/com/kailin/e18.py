...
stock = ['0050', '1301', '2330', '2409', '2890', '6180']
...
def stockPredict(stockcode, code):
    ...
    if code == 0:
        try:
            ...
            print()
        history = model.fit(trainX, trainY, epochs=20, batch_size=240, validation_split=0.1, verbose=2)
